...
export async function middleware(request: NextRequest) {
    const allowedOrigin = process.env.NEXT_PUBLIC_ASAP_PROTOCOL_URL || "https://asap-protocol.vercel.app"
    ...
    if (request.nextUrl.pathname.startsWith("/api")) {
        ...
        if (requestOrigin && !requestOrigin.startsWith(allowedOrigin) && !requestOrigin.startsWith("http://localhost")) {
